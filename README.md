...
A comprehensive Python tool for working with Unity IL2CPP global-metadata.dat files. Supports 20+ decryption methods and metadata versions 15-43 (Unity 2015-2026+).
...
- Telegram Group: [t.me/MetadataWorker](https://t.me/MetadataWorker)
...
Многофункциональный Python инструмент для работы с файлами global-metadata.dat из Unity IL2CPP. Поддерживает 20+ методов расшифровки и версии метаданных 15-43 (Unity 2015-2026+).
